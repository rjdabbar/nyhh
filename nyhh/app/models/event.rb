...
class Event < ActiveRecord::Base
  ...
  after_validation :geocode, :if => :location_changed?
	attr_accessible :event_name, :location, :borough,:ticket_price, :ticket_add_1, :ticket_add_2, :featured,:user_id,:avatar_file_name,:date,:approved,:avatar,:flyer,:description,:latitude,:longitude,:start,:end
